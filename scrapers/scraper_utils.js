...
const DEFAULT_CATEGORIES = {
  ...
  // קטגוריות מאוחדות ולא מפורטות - לא בגדים, נאספות אך מוסתרות כברירת מחדל בתוצאות חיפוש
  // (ראה ACCESSORY_CATEGORIES ב-index.js) כי הן פחות "מרשימות" בתמונה מול הבגדים עצמם,
  // ונגישות רק אם נבחרות במפורש בסינון קטגוריה.
  'תכשיטים':['תכשיט','תכשיטים','שרשרת','שרשראות','עגיל','עגילים','חישוק','חישוקים','צמיד','צמידים','טבעת','טבעות','עדי','עדיים','jewelry','jewellery','necklace','earring','earrings','bracelet','ring'],
  'אביזרים':['אביזר','אביזרים','חגורה','חגורות','כובע','כובעים','צעיף','צעיפים','סרט','סרטים','סרט לשיער','תיק','תיקים','ארנק','ארנקים','גומייה','גומיות','גומי לשיער','משקפי שמש','משקפיים','belt','hat','cap','scarf','headband','bag','purse','wallet','accessory','accessories','sunglasses'],
  'נעליים':['נעל','נעליים','נעלי','נעלת','סנדל','סנדלים','מגף','מגפיים','מגפון','מגפונים','נעלי בית','כפכף','כפכפים','shoe','shoes','sandal','sandals','boot','boots','footwear'],
};
