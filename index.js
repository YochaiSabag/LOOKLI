...
app.post('/api/admin/scraper-config/seed', adminAuth, async (req, res) => {
  const allMaps = [
    ...
    ['category', {'שמלה':['שמלה','שמלת','dress'],'חולצה':['חולצה','חולצת','טופ','top','shirt','blouse'],'חצאית':['חצאית','skirt'],'קרדיגן':['קרדיגן','cardigan'],'סוודר':['סוודר','sweater'],'טוניקה':['טוניקה','tunic'],'סרפן':['סרפן','pinafore'],"ז׳קט":["ז׳קט","ג׳קט",'jacket'],'בלייזר':['בלייזר','blazer'],'וסט':['וסט','vest'],'עליונית':['עליונית','שכמיה','cape'],'מעיל':['מעיל','coat'],'אוברול':['אוברול','jumpsuit'],'סט':['סט','set'],'בייסיק':['בייסיק','basic'],'חלוק':['חלוק','robe'],'תכשיטים':['תכשיט','תכשיטים','שרשרת','שרשראות','עגיל','עגילים','חישוק','חישוקים','צמיד','צמידים','טבעת','טבעות','עדי','עדיים','jewelry','jewellery','necklace','earring','earrings','bracelet','ring'],'אביזרים':['אביזר','אביזרים','חגורה','חגורות','כובע','כובעים','צעיף','צעיפים','סרט','סרטים','סרט לשיער','תיק','תיקים','ארנק','ארנקים','גומייה','גומיות','גומי לשיער','משקפי שמש','משקפיים','belt','hat','cap','scarf','headband','bag','purse','wallet','accessory','accessories','sunglasses'],'נעליים':['נעל','נעליים','נעלי','נעלת','סנדל','סנדלים','מגף','מגפיים','מגפון','מגפונים','נעלי בית','כפכף','כפכפים','shoe','shoes','sandal','sandals','boot','boots','footwear']}],
